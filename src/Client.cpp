...
void Client::fire(unsigned int x, unsigned int y) {
    string player_board;
    if(player == 1){
        player_board = "player_1.action_board.json";
    }else if(player == 2){
        player_board = "player_2.action_board.json";
    }
    int x_co = x;
    int y_co = y;
...
void Client::update_action_board(int result, unsigned int x, unsigned int y) {
    string board;
    if(player == 1){
        board = "player_1.action_board.json";
    }else if(player == 2){
        board = "player_2.action_board.json";
    }
